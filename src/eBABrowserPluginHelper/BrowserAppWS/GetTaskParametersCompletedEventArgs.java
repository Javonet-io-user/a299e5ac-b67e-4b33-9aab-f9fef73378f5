...
public class GetTaskParametersCompletedEventArgs extends AsyncCompletedEventArgs {
  protected NObject javonetHandle;
  /** GetProperty */
  public KeyValueItem[] getResult(Class<?> returnArrayType) {
    try {
  ...
  public GetTaskParametersCompletedEventArgs(NObject handle) {
    super(handle);
