...
public class GetUpdateFileNamesCompletedEventArgs extends AsyncCompletedEventArgs {
  protected NObject javonetHandle;
  /** GetProperty */
  public UpdateFile[] getResult(Class<?> returnArrayType) {
    try {
  ...
  public GetUpdateFileNamesCompletedEventArgs(NObject handle) {
    super(handle);
