...
public class CreateFileContentFromPartsCompletedEventArgs extends AsyncCompletedEventArgs {
  ...
  public CreateFileContentFromPartsCompletedEventArgs(NObject handle) {
    super(handle);
