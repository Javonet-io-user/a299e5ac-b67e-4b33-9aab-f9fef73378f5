...
public class ws extends SoapHttpClientProtocol implements IComponent, IDisposable {
  ...
  public ws() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("eBABrowserPluginHelper.PluginDMWSRemote.ws");
      ...
      javonetHandle.addEventListener(
          "DeleteDataIdCompleted",
          new com.javonet.api.INEventListener() {
            @Override
            public void eventOccurred(Object[] objects) {
              for (DeleteDataIdCompletedEventHandler handler : _DeleteDataIdCompletedListeners) {
                handler.Invoke(
                    Convert(objects[0], Object.class),
                    Convert(objects[1], AsyncCompletedEventArgs.class));
              }
  ...
  public void DeleteDataId(
      java.lang.String path, java.lang.Integer libraryId, java.lang.Integer dataId) {
    try {
      javonetHandle.invoke("DeleteDataId", path, libraryId, dataId);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public void DeleteDataIdAsync(
      java.lang.String path, java.lang.Integer libraryId, java.lang.Integer dataId) {
    try {
      javonetHandle.invoke("DeleteDataIdAsync", path, libraryId, dataId);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public void DeleteDataIdAsync(
      ...
      Object userState) {
    try {
      javonetHandle.invoke("DeleteDataIdAsync", path, libraryId, dataId, userState);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean CreateFileFromParts(
    ...
    try {
      java.lang.Boolean res =
          javonetHandle.invoke("CreateFileFromParts", server, userId, password, tempFileId, dmpath);
      if (res == null) return false;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void CreateFileFromPartsAsync(
    ...
    try {
      javonetHandle.invoke(
          "CreateFileFromPartsAsync", server, userId, password, tempFileId, dmpath);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public void CreateFileFromPartsAsync(
    ...
    try {
      javonetHandle.invoke(
          "CreateFileFromPartsAsync", server, userId, password, tempFileId, dmpath, userState);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  private java.util.ArrayList<DeleteDataIdCompletedEventHandler> _DeleteDataIdCompletedListeners =
      new java.util.ArrayList<DeleteDataIdCompletedEventHandler>();

  public void addDeleteDataIdCompleted(DeleteDataIdCompletedEventHandler toAdd) {
    _DeleteDataIdCompletedListeners.add(toAdd);
  }

  public void removeDeleteDataIdCompleted(DeleteDataIdCompletedEventHandler toRemove) {
    _DeleteDataIdCompletedListeners.remove(toRemove);
  }
  /** Event */
