...
public class GetFileDataPartsCompletedEventArgs extends AsyncCompletedEventArgs {
  protected NObject javonetHandle;
  /** GetProperty */
  public java.lang.Byte[] getResult(Class<?> returnArrayType) {
    try {
  ...
  public GetFileDataPartsCompletedEventArgs(NObject handle) {
    super(handle);
